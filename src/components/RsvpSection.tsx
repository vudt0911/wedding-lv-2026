...
import { FaComment, FaFacebookMessenger } from 'react-icons/fa';
...
const RsvpSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <motion.a
          href={weddingConfig.contacts.brideFacebook}
          target="_blank"
          rel="noopener noreferrer"
          whileHover={{ scale: 1.01 }}
          whileTap={{ scale: 0.98 }}
          className="flex items-center justify-center gap-2 px-6 py-4 bg-gray-100 text-gray-800 rounded-xl hover:bg-blue-50 hover:text-blue-600 transition-colors duration-300 font-medium"
        >
          <FaFacebookMessenger className="text-blue-600 text-lg" />
          <span>Messenger Cô Dâu</span>
        </motion.a>

        <motion.a
          href={weddingConfig.contacts.groomFacebook}
          target="_blank"
          rel="noopener noreferrer"
          whileHover={{ scale: 1.01 }}
          whileTap={{ scale: 0.98 }}
        ...
        <motion.a
          ...
          whileHover={{ scale: 1.01 }}
          whileTap={{ scale: 0.98 }}
          className="flex items-center justify-center gap-2 px-6 py-4 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-colors duration-300 font-medium"
        >
          <FaComment />
          <span>Nhắn Zalo</span>
        </motion.a>
